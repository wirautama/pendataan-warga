...
<form action="/warga/insert" method="POST" enctype="multipart/form-data">
    ...
    <table class="table table-striped table-middle">
      <tr>
        ...
        <td width="1%">:</td>
        <td>
            <input type="text" name="nik_warga" value="{{ old('nik_warga') }}" class="form-control @error('nik_warga') is-invalid @enderror">
      ...
      <tr>
        <th>Nama Warga</th>
        <td>:</td>
        <td><input type="text" name="nama_warga" value="{{ old('nama_warga') }}" class="form-control @error('nama_warga') is-invalid @enderror"></td>
      </tr>
      <tr>
        <th>Tempat Lahir</th>
        <td>:</td>
        <td><input type="text" name="tempat_lahir_warga" value="{{ old('tempat_lahir_warga') }}" class="form-control @error('tempat_lahir_warga') is-invalid @enderror"></td>
      </tr>
      <tr>
        <th>Tanggal Lahir</th>
        <td>:</td>
        <td><input type="date" name="tanggal_lahir_warga" value="{{ old('tanggal_lahir_warga') }}" class="form-control @error('tanggal_lahir_warga') is-invalid @enderror"></td>
      </tr>
      <tr>
        <th>Jenis Kelamin</th>
        <td>:</td>
        <td>
          <select class="form-control selectpicker" name="jenis_kelamin_warga" value="{{ old('jenis_kelamin_warga') }}" @error('jenis_kelamin_warga') is-invalid @enderror>
    ...
    <table class="table table-striped table-middle">
      <tr>
        ...
        <td width="1%">:</td>
        <td><textarea name="alamat_ktp_warga" value="{{ old('jenis_kelamin_warga') }}" class="form-control @error('alamat_ktp_warga') is-invalid @enderror"></textarea></td>
      </tr>
      <tr>
        <th>Alamat</th>
        <td>:</td>
        <td><textarea class="form-control @error('alamat_warga') is-invalid @enderror" name="alamat_warga" required></textarea></td>
      </tr>
      <tr>
      ...
      <tr>
        <th>RT</th>
        <td>:</td>
        <td><input type="text" class="form-control @error('rt_warga') is-invalid @enderror" name="rt_warga" required></td>
      </tr>
      <tr>
        <th>RW</th>
        <td>:</td>
        <td><input type="text" class="form-control @error('rw_warga') is-invalid @enderror" name="rw_warga" required></td>
      </tr>
    </table>
    ...
    <table class="table table-striped table-middle">
      ...
      <tr>
        <th>Pekerjaan</th>
        <td>:</td>
        <td><input type="text" class="form-control @error('pekerjaan_warga') is-invalid @enderror" name="pekerjaan_warga"></td>
      </tr>
      <tr>
